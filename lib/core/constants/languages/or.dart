class AppStringsOr {
  ...
  static const String homeTitle =
      'Beekumsa Uumamaa Bareedina Gogaa keef Argadhu';
  static const String homeSubtitle =
      'Qoricha aadaa Itiyoophiyaa fi qorannoo ammayyaa walitti makamee imala kee ni deeggaru';
  ...
  static const String step1Desc =
      'Maqaa ykn rakkoo irratti hundaa\'uun barbaadi';
  ...
  static const String comprehensiveDbDesc =
      'Odeeffannoo mirkanaa\'e biqiltoota Itiyoophiyaa 100+ argadhu';
  static const String evidenceBased = 'Ragaa irratti hundaa\'e';
  static const String evidenceBasedDesc =
      'Odeeffannoon hundi qorattootaa fi ogeeyyii irraa mirkanaa\'e';
  ...
  static const String searchHint =
      'Maqaa ykn saayinsii irratti hundaa\'uun barbaadi...';
  ...
  static const String recommendationsSubtitle =
      'Qoricha aadaa Itoophiyaa rakkoo gogaa keetiif qophaa’e argadhu';
  ...
  static const String selectAllThatApply =
      'Kan si ilaallatu hunda filadhu gorsa dhuunfaa argachuuf';
  static const String selectYourConcerns = 'Rakkoolee Gogaa Kee Filadhu';
  static const String chooseConditions =
      'Rakkoolee si ilaallatan hunda filadhu. Sadarkaa cimaa isaanii ibsi gorsa sirrii argachuuf';
  ...
  static const String tip3 =
      'Qorichi aadaa Itoophiyaa yeroo hedduu biqiltoota hedduu walitti makuun fayyadama';
  ...
  static const String selectAtLeastOne =
      'Yoo xiqqaate rakkoo gogaa tokko filadhu itti fufuuf';
  static const String privacyNotice =
      'Odeeffannoon kee dhuunfaa dha, gorsa fooyya’aa kennuuf qofa fayyadama';
  ...
  static const String bridgingWisdom =
      'Beekumsa durii fi fayyaa ammayyaa walitti fiduu';
  static const String herbiSenseDescription =
      'HerbiSense iddoo addaa namoota, maatii fi warra qoricha aadaa biqiltootaa irratti hojjetan hundaaf qophaa’e dha, keessumaa daa’immaniif. Kaayyoon keenya dhaala kana salphaatti argamuu gochuu dha.';
  static const String herbiSenseMission =
      'Qoricha dhugaa fi guutuu ta’e akka argattan isin waliin walqunnamsiisuu dha, akkasumas seenaa fi beekumsa durii eeguudha.';
  static const String ourMission = 'Ergama Keenya: Fayyaa Cimsuu fi Aadaa Eegu';
  static const String missionDescription1 =
      'Beekumsa aadaa guddisuu, eegu fi qooduuf kutannoo qabna. Oomisha uumamaa fayyadamuun dhugaa fi badhaadhina aadaa dhiheessina.';
  static const String missionDescription2 =
      'Qorannoo fi hojii waloo hawaasaa waliin hojjechuun oomisha aadaa fi naannoo waliin waliigalu uumna.';
  ...
  static const String legacyDescription1 =
      'Qorichi aadaa Itoophiyaa seenaa dheeraa fi beekumsa durii irratti hundaa’e har’as jiraata. Dhalootarraa dhalootatti darbaa jira.';
  static const String legacyDescription2 =
      'Dhaala kana eeguuf fi guddisuuf hojjechaa jirra, akkasumas jireenya ammayyaa waliin wal simsiifna.';
  static const String legacyDescription3 =
      'Ogeeyyiin hojii isaanii keessatti qoricha uumamaa fayyadamuun mala haaraa fi aadaa walitti makaa uumu.';
  ...
  static const String valuesDescription =
      'Sirrummaa saayinsii, kabaja aadaa fi hojii waloo hawaasaa dursa kennina. Namoonni biroo imala isaanii akka ijaaranii fi eegan gargaaruuf qophiidha.';
  ...
  static const String futureDescription =
      'Yeroo guddannu, gahumsa keenya addunyaa irratti bal’isuu fi beekumsa keenya cimsuuf hojjanna. Beekumsa kana dhalootaaf dabarsuuf kutannoodhaan hojjanna.';
  static const String ourRoadmap = 'Kaartaa Karooraa Keenya';
  static const String commitmentStatement =
      'Oomisha qulqullina olaanaa, nageenya fi itti fufiinsa qabu dhiyeessuuf kutannoo qabna.';
  ...
  static const String journeyDescription =
      'Gorsa dhuunfaa, wantoota kuufatte fi beekumsa aadaa baradhu';
  ...
  // Register Page
  static const String joinEnthusiasts =
      '10,000+ namoota biqiltoota jaallatan waliin ta’i';
  static const String startYourJourney = 'Imala kee har’a jalqabi';
  static const String createAccountDescription =
      'Akkaawuntii uumi, wantoota kuusi fi hawaasa waliin ta’i';
  ...
  static const String registrationFailed =
      'Galmeen hin milkoofne. Irra deebi’i yaali';
  ...
  static const String favoritesLoadErrorTitle =
      'Kan jaallataman fe\'uu hin dandeenye';
  static const String favoritesLoadErrorBody =
      'Kan jaallataman argachuuf galmaa\'i ykn seeni';
  static const String favoritesLinkedHerbError =
      'Herb walqabate fe\'uu hin dandeenye';
  static const String favoritesHerbNotFound =
      'Odeeffannoo biqiltootaa hin argamne';
  static const String favoritesOpenTooltip = 'Herb banuu';
  static const String favoritesRemoveTooltip =
      'Kan jaallataman keessaa balleessi';
  ...
  static const String feedbackGenericError =
      'Dogoggorri uumame. Amma booda irra deebi\'i.';
  static const String feedbackRequired = 'Barbaachisa';
  static const String conditionDetails = 'Ibsa Haala Gogaa';
  static const String conditionName = 'Maqaa Haala';
  static const String conditionDescription = 'Ibsa Haala';
  static const String primaryHerb = 'Qoricha Ijo';
  static const String recommendedHerbs = 'Qorichaalee Gorsaaf';
